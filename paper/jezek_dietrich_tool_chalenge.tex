...
\textit{``In this age of collaborative software development, the importance of usable APIs is well recognized''} and continues: \textit{``ideally, the users of a module need to look no further than its API''}. He proposes metrics that help either design or recognise a ``good'' API. 
