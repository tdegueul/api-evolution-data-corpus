...
We searched for tools that are capable of discovering API syntactic backward compatibility. They are listed in Table \ref{tab:tools} together with basic information about their authors, current versions, licensing and basic usages. All these tools were benchmarked to discover how they cope with searching for incompatibilities. Results are provided in this section.
...
Binary	& 86.36\%	&	90.91\%	&	81.82\%	&	86.36\%		&	90.91\%		&	90.91\%		&	90.91\%	&	86.36\%	&	90.91\%		\\
