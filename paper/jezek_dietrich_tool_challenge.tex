...
\todo[inline]{Improve RQ1 to be more challenging}
\begin{enumerate}
\item[RQ1] Can we provide synthetic datacorpus that mimics library evolution?
\item[RQ2] Do the existing tools reliably check API syntactical compatibility?
\item[RQ3] Do the tools correctly distinguish between source and binary compatibility?
\end{enumerate}
...
\paragraph{RQ2 -- Do the existing tools reliably check API syntactical compatibility}
...
\paragraph{RQ3 -- Do the tools correctly distinguish between source and binary compatibility}
