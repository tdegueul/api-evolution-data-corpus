...
The data set is organised in eight top level categories: access modifiers, data types, exceptions, generics, inheritance, class members, other (non-access) modifiers and miscellaneous. Each category has several programs constructed using ideas from section 13 of the Java Language Specification, the catalogue by Rivieres \cite{EvolvingJavaAPIs:2007}, work by Dietrich \cite{dietrich14broken} and information found on developer forums. The corpus is extensible.
