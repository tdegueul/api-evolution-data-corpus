...
echo "********* japicmp *********"
record_execution_time "japicmp" "java -jar tools/japicmp/japicmp-0.23.0-jar-with-dependencies.jar -o output/build/lib-v1.jar -n output/build/lib-v2.jar -b -m > $REPORTS_DIRECTORY/japicmp.txt"
