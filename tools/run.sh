...
echo "********* japicmp *********"
record_execution_time "japicmp" "java -jar tools/japicmp/japicmp-0.23.1-jar-with-dependencies.jar -o output/build/lib-v1.jar -n output/build/lib-v2.jar -m > $REPORTS_DIRECTORY/japicmp.txt"
